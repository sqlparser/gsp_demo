...
namespace demos.dlineage.metadata
{
    ...
    using foreignKey = demos.dlineage.model.ddl.schema.foreignKey;
    using index = demos.dlineage.model.ddl.schema.index;
    using indexColumn = demos.dlineage.model.ddl.schema.indexColumn;
    using reference = demos.dlineage.model.ddl.schema.reference;
    using unique = demos.dlineage.model.ddl.schema.unique;
    using uniqueColumn = demos.dlineage.model.ddl.schema.uniqueColumn;
    ...
    using procedureImpactResult = demos.dlineage.model.xml.procedureImpactResult;
