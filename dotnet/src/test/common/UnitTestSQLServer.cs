...
namespace gudusoft.gsqlparser.test
{
    ...
    public class UnitTestSQLServer
    {
        ...
        {
            TGSqlParser parser = new TGSqlParser(EDbVendor.dbvmssql);
            String[] allfiles = System.IO.Directory.GetFiles(@"c:\prg\gsqlparser\Test\TestCases\MSSQL\", "*.sql", System.IO.SearchOption.AllDirectories);
            int cnt = 0;
