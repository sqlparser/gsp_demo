...
namespace gudusoft.gsqlparser.test
{
    ...
    public class UnitTestTeradata
    {
        ...
        {
            String[] allfiles = System.IO.Directory.GetFiles(@"c:\prg\gsqlparser\Test\TestCases\teradata\verified\", "*.sql", System.IO.SearchOption.AllDirectories);
            int cnt = 0;
