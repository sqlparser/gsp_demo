...
namespace gudusoft.gsqlparser.test
{
    ...
    public class UnitTestOracle
    {
        ...
        {
            String[] allfiles = System.IO.Directory.GetFiles(@"c:\prg\gsqlparser\Test\TestCases\oracle\", "*.sql", System.IO.SearchOption.AllDirectories);
            int cnt = 0;
