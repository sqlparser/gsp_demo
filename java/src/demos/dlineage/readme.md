...
This tool is built from the scratch and doesn't use the based code from Dlineage and DlineageRelation demo.
...
[This DataFlowAnalyzer web version](http://107.170.101.241:8080/dataflow/) can also generates Graph XML result which can be visualized by 
[yEd Graph Editor](https://www.yworks.com/products/yed) correctly.
