...
This tool is built from the scratch and doesn't use the base code from Dlineage and DlineageRelation demo.
...
[Dlineage GUI Demo](https://github.com/sqlparser/gsp_demo/tree/master/dlineage-demo) is a GUI tool visualizes the end-to-end data lineage
use the same code base as this one.

[This DataFlowAnalyzer web version](http://107.170.101.241:8080/dataflow/) can also generates Graph XML based on the XML output generated by this tool
 which can be visualized by [yEd Graph Editor](https://www.yworks.com/products/yed) correctly.
